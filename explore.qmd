...
- If the distribution of simulated R^2 values is similar to the observed model R^2, this suggests our model is a reasonable fit for the data.
- If the observed R^2 falls far outside the simulated distribution, our model may be missing key variables or interactions.